...
class DioMutiUtils {
  ...
  factory DioMutiUtils(String baseUrl) {
    return DioMutiUtils._internal(baseUrl);
  }
  ...
  DioMutiUtils._internal(String baseUrl) {
...
//    };
  ...
  Future<BaseEntity<T>> _request<T>(String method, String url,
    ...
    try {
      ...
      _code = int.parse(_map[Constant.code]);
      _msg = _map[Constant.message];
      if (_map.containsKey(Constant.result)) {
        if (T.toString() == "String") {
          _data = _map[Constant.result].toString() as T;
        } else if (T.toString() == "Map<dynamic, dynamic>") {
          _data = _map[Constant.result] as T;
        } else {
          _data = _map[Constant.result];
        }
      }
    } catch (e) {
      print(e);
  ...
  Future<BaseEntity<List<T>>> _requestList<T>(String method, String url,
    ...
    try {
      ...
      _msg = _map[Constant.message];
      if (_map.containsKey(Constant.result)) {
        (_map[Constant.result] as List).forEach((item) {
